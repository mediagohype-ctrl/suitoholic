...
export default function NewsletterSection() {
  ...
  return (
    <section className="w-full max-w-[1680px] mx-auto px-4 sm:px-6 lg:px-14 xl:px-20 my-8 sm:my-10 select-none">
      <div className="relative w-full bg-[#EDE4DB] rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 border border-[#D6C5B5] shadow-[0_10px_30px_rgba(20,17,14,0.05)] overflow-hidden">
